...
!function (n) {
    ...
    var C, U, t, e, $ = function (e, H) {
            ...
            return $.factory(e, H) ? $ : this instanceof $ ? B(e).DataTable(H) : (X = void 0 === (H = e), V = (W = this).length, X && (H = {}), this.api = function () {
                ...
                var n = 1 < V ? Ge({}, H, !0) : H, a = 0, e = this.getAttribute("id"), r = !1, t = $.defaults, o = B(this);
                if ("table" != this.nodeName.toLowerCase()) Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    var u = B.extend(!0, {}, $.models.oSettings, {
                        ...
                        }), r = !0) : ee(u, null, "i18n", [u]), []), h = this.getElementsByTagName("thead"),
                        p = Ce(u, h[0]);
                    ...
                    if (T) for (g = T.length - 1; 0 <= g; g--) {
                        ...
                        for (Array.isArray(I) || (I = [I]), v = 0, b = I.length; v < b; v++) {
                            ...
                            if ("number" == typeof A && 0 <= A) {
                                for (; C.length <= A;) re(S);
                                _(A, x)
                            } else if ("number" == typeof A && A < 0) _(C.length + A, x); else if ("string" == typeof A) for (y = 0, D = C.length; y < D; y++) -1 !== A.indexOf(":name") ? C[y].sName === A.replace(":name", "") && _(y, x) : M.forEach(function (e) {
                                e = B(e[y].cell);
            ...
            return B.isPlainObject(a) ? $.util.set(a._) : null === a ? function () {
                ...
                for (var a, r, o, i, l = de(n), n = l[l.length - 1], s = 0, u = l.length - 1; s < u; s++) {
                    ...
                    if (a = l[s].match(ce), r = l[s].match(p), a) {
                        if (l[s] = l[s].replace(ce, ""), e[l[s]] = [], (a = l.slice()).splice(0, s + 1), i = a.join("."), Array.isArray(t)) for (var c = 0, d = t.length; c < d; c++) f(o = {}, t[c], i), e[l[s]].push(o); else e[l[s]] = t;
                        return
                    }
    ...
    function re(e) {
        var t = $.defaults.column, n = e.aoColumns.length, t = B.extend({}, $.models.oColumn, t, {
    ...
    function E(e) {
        ...
        if (t.oFeatures.bAutoWidth) {
            var n, a, r = t.nTable, o = t.aoColumns, i = t.oScroll, l = i.sY, s = i.sX, i = i.sXInner,
                u = W(t, "bVisible"), c = r.getAttribute("width"), d = r.parentNode, f = r.style.width,
                ...
                var p = function (e, t) {
                        ...
                        if (!n.maxLenString) {
                            for (var a, r = "", o = -1, i = 0, l = e.aiDisplayMaster.length; i < l; i++) {
                                var s = e.aiDisplayMaster[i], s = me(e, s)[t],
                    ...
                    }(t, p), g = C.type.className[a.sType], m = p + a.sContentPadding,
    ...
    function H(e) {
        var t = e.aoHeader, n = e.aoColumns, a = 0;
    ...
    function me(e, t) {
        var n = e.aoData[t], a = e.aoColumns;
        if (!n.displayData) {
            n.displayData = [];
    ...
    function ye(e, t) {
        var n, a, r, o = e.oClasses, i = e.aoColumns, l = "header" === t ? e.nTHead : e.nTFoot,
            s = "header" === t ? "sTitle" : t;
        if (l) {
            if (0 === B("th, td", l).length && ("header" === t || h(e.aoColumns, s).join(""))) for (r = B("<tr/>").appendTo(l), n = 0, a = i.length; n < a; n++) B("<th/>").html(i[n][s] || "").appendTo(r);
            var u = Ce(e, l, !0);
    ...
    function S(e, t) {
        if (r = "ssp" == te(s = e), void 0 !== (i = s.iInitDisplayStart) && -1 !== i && (s._iDisplayStart = !r && i >= s.fnRecordsDisplay() ? 0 : i, s.iInitDisplayStart = -1), -1 !== ee(e, "aoPreDrawCallback", "preDraw", [e]).indexOf(!1)) w(e, !1); else {
            var l, n = [], a = 0, r = "ssp" == te(e), o = e.aiDisplay, i = e._iDisplayStart, s = e.fnDisplayEnd(),
                u = e.aoColumns, c = B(e.nTBody);
            if (e.bDrawing = !0, r) {
                if (!e.bDestroying && !t) return 0 === e.iDraw && c.empty().append(Se(e)), (l = e).iDraw++, w(l, !0), void Ie(l, function (t) {
                    ...
                    var a = t.aoColumns, e = t.oFeatures, r = t.oPreviousSearch, o = t.aoPreSearchCols;
                    return {
                        draw: t.iDraw,
                        ...
                        search: {
                            value: r.search, regex: r.regex, fixed: Object.keys(t.searchFixed).map(function (e) {
                                return {name: e, term: t.searchFixed[e].toString()}
                            })
                        }
                    }
                }(l), function (e) {
                    var t = l, n = Ae(t, e = e), a = Fe(t, "draw", e), r = Fe(t, "recordsTotal", e),
    ...
    function c(e, t, n) {
        var a = e.oFeatures, r = a.bSort, a = a.bFilter;
    ...
    function Se(e) {
        var t = e.oLanguage, n = t.sZeroRecords, a = te(e);
    ...
    function Te(e, t, n) {
        for (var a = {}, r = (B.each(t, function (e, t) {
            ...
            } : e[n] = {contents: t}, Array.isArray(e[n].contents)) || (e[n].contents = [e[n].contents])
        ...
        }), "bottom" === n && r.reverse(), []), i = 0, l = r.length; i < l; i++) r[i].val.full && (o.push({full: r[i].val.full}), we(e, o[o.length - 1]), delete r[i].val.full), Object.keys(r[i].val).length && (o.push(r[i].val), we(e, o[o.length - 1]));
        return o
    }
    ...
    function _e(t) {
        var a, e = t.oClasses, n = B(t.nTable),
            r = B("<div/>").attr({id: t.sTableId + "_wrapper", class: e.container}).insertBefore(n),
            e = (t.nTableWrapper = r[0], Te(t, t.layout, "top")), n = Te(t, t.layout, "bottom"), o = Qe(t, "layout");
        if (t.sDom) for (var i, l, s, u, c, d, f = t, h = t.sDom, p = r, g = h.match(/(".*?")|('.*?')|./g), m = 0; m < g.length; m++) i = null, "<" == (l = g[m]) ? (s = B("<div/>"), "'" != (u = g[m + 1])[0] && '"' != u[0] || (u = u.replace(/['"]/g, ""), c = "", -1 != u.indexOf(".") ? (d = u.split("."), c = d[0], d = d[1]) : "#" == u[0] ? c = u : d = u, s.attr("id", c.substring(1)).addClass(d), m++), p.append(s), p = s) : ">" == l ? p = p.parent() : "t" == l ? i = He(f) : $.ext.feature.forEach(function (e) {
            l == e.cFeature && (i = e.fnInit(f))
        }), i && p.append(i); else e.forEach(function (e) {
            o(t, r, e)
        }), o(t, r, {full: {table: !0, contents: [He(t)]}}), n.forEach(function (e) {
            o(t, r, e)
        });
        h = t, e = h.nTable;
    ...
    function Ne(e, t, n, a, r) {
        if ("" !== n) for (var o = 0, i = "function" == typeof n ? n : null, l = n instanceof RegExp ? n : i ? null : function (e, t) {
            var a = [], t = B.extend({}, {boundary: !1, caseInsensitive: !0, exact: !1, regex: !1, smart: !0}, t);
            ...
            var s = t.aoData[e[o]], u = void 0 === r ? s._sFilterRow : s._aFilterData[r];
            (i && !i(u, s._aData, e[o], r) || l && !l.test(u)) && (e.splice(o, 1), o--), o++
        }
    }

    var je = $.util.escapeRegex, Pe = B("<div>")[0], Re = void 0 !== Pe.textContent;
    ...
    function He(e) {
        ...
        return "" === g.sX && "" === g.sY ? e.nTable : (t = g.sX, n = g.sY, a = e.oClasses.scrolling, o = (r = e.captionNode) ? r._captionSide : null, u = B(p[0].cloneNode(!1)), i = B(p[0].cloneNode(!1)), c = function (e) {
            return e ? A(e) : null
        }, (l = p.children("tfoot")).length || (l = null), u = B(s = "<div/>", {class: a.container}).append(B(s, {class: a.header.self}).css({
            overflow: "hidden",
            position: "relative",
            border: 0,
            width: t ? c(t) : "100%"
        }).append(B(s, {class: a.header.inner}).css({
            "box-sizing": "content-box",
            width: g.sXInner || "100%"
        }).append(u.removeAttr("id").css("margin-left", 0).append("top" === o ? r : null).append(p.children("thead"))))).append(B(s, {class: a.body}).css({
            position: "relative",
            overflow: "auto",
            width: c(t)
        }).append(p)), l && u.append(B(s, {class: a.footer.self}).css({
            overflow: "hidden",
            border: 0,
            width: t ? c(t) : "100%"
        }).append(B(s, {class: a.footer.inner}).append(i.removeAttr("id").css("margin-left", 0).append("bottom" === o ? r : null).append(p.children("tfoot"))))), c = u.children(), d = c[0], f = c[1], h = l ? c[2] : null, B(f).on("scroll.DT", function () {
    ...
    function We(e) {
        var t, n, a = e.oScroll.iBarWidth, r = B(e.nScrollHead).children("div"), o = r.children("table"),
            i = e.nScrollBody, l = B(i), s = B(e.nScrollFoot).children("div"), u = s.children("table"), c = B(e.nTHead),
            d = B(e.nTable), f = e.nTFoot && B("th, td", e.nTFoot).length ? B(e.nTFoot) : null, h = e.oBrowser,
    ...
    function qe(e) {
        var t, n, a, r, o, i, l, s = [], u = $.ext.type.order, c = e.aoColumns, d = e.aaSortingFixed,
            f = B.isPlainObject(d), h = [];
        if (e.oFeatures.bSort) for (Array.isArray(d) && Be(e, h, d), f && d.pre && Be(e, h, d.pre), Be(e, h, e.aaSorting), f && d.post && Be(e, h, d.post), t = 0; t < h.length; t++) if (c[l = h[t][0]]) for (n = 0, a = (r = c[l].aDataSort).length; n < a; n++) i = c[o = r[n]].sType || "string", void 0 === h[t]._idx && (h[t]._idx = c[o].asSorting.indexOf(h[t][1])), h[t][1] && s.push({
            src: l,
            col: o,
            dir: h[t][1],
            index: h[t]._idx,
    ...
    function Qe(e, t) {
        var e = e.renderer, n = $.ext.renderer[t];
    ...
    function Ke(e, t, n) {
        var a = e.fnFormatNumber, r = e._iDisplayStart + 1, o = e._iDisplayLength, i = e.fnRecordsDisplay(),
    ...
    U = function (e, t) {
        ...
        iterator: function (e, t, n, a) {
            ...
            for ("string" == typeof e && (a = n, n = t, t = e, e = !1), o = 0, i = h.length; o < i; o++) {
                var g = new U(h[o]);
                if ("table" === t) void 0 !== (r = n.call(g, h[o], o)) && f.push(r); else if ("columns" === t || "rows" === t) void 0 !== (r = n.call(g, h[o], this[o], o)) && f.push(r); else if ("every" === t || "column" === t || "column-rows" === t || "row" === t || "cell" === t) for (c = this[o], "column-rows" === t && (u = ct(h[o], p.opts)), l = 0, s = c.length; l < s; l++) d = c[l], void 0 !== (r = "cell" === t ? n.call(g, h[o], d.row, d.column, o, l) : n.call(g, h[o], d, o, l, u)) && f.push(r)
            }
        ...
        if (n.length && t && (t instanceof U || t.__dt_wrapper)) for (var a, r = 0, o = n.length; r < o; r++) t[(a = n[r]).name] = "function" === a.type ? function (t, n, a) {
            return function () {
        ...
        if (Array.isArray(e)) for (var n = 0, a = e.length; n < a; n++) U.register(e[n], t); else for (var r = e.split("."), o = et, i = 0, l = r.length; i < l; i++) {
    ...
    t("tables()", function (e) {
        ...
        return void 0 === r ? (e = t[0].captionNode) && t.length ? e.innerHTML : null : this.iterator("table", function (e) {
            var t = B(e.nTable), n = B(e.captionNode), a = B(e.nTableWrapper);
    ...
    function lt(e, t) {
        ...
        if (n.length && e.length) {
            ...
            if (a._details) {
                ...
                var i = n[0], r = new U(i), a = ".dt.DT_details", t = "draw" + a, e = "column-sizing" + a,
                    a = "destroy" + a, l = i.aoData;
                if (r.off(t + " " + e + " " + a), h(l, "_details").length > 0) {
                    r.on(t, function (e, t) {
                        if (i !== t) return;
                        r.rows({page: "current"}).eq(0).each(function (e) {
                            var t = l[e];
    ...
    var ct = function (e, t) {
        ...
        return this.iterator("row", function (e, t) {
            var n = e.aoData, a = n[t], r = e.aiDisplayMaster.indexOf(t),
    ...
    }, pt = "row().child", gt = pt + "()", mt = (t(gt, function (e, t) {
        var n = this.context;
    ...
    }), /^([^:]+):(name|title|visIdx|visible)$/), gt = (t("columns()", function (n, a) {
        ...
        var t = this, r = [], e = this.iterator("column", function (e, t) {
            ...
            !function (e, t, n) {
                ...
                if (n) for (var s = h(o, "bVisible").indexOf(!0, t + 1), u = 0, c = l.length; u < c; u++) l[u] && (r = l[u].nTr, a = l[u].anCells, r) && r.insertBefore(a[t], a[s] || null); else B(h(e.aoData, "anCells", t)).detach();
        ...
        var e = this.columns(":visible").count(), e = B("<tr>").html("<td>" + Array(e).join("</td><td>") + "</td>"),
        ...
        return B.isPlainObject(g) && (void 0 === g.row ? (m = g, g = null) : (m = e, e = null)), B.isPlainObject(e) && (m = e, e = null), null == e ? this.iterator("table", function (e) {
            ...
            return n
        }, 1), t = m && m.selected ? this.cells(t, m) : t, B.extend(t.selector, {cols: e, rows: g, opts: m}), t)
        ...
        return void 0 === t ? 0 !== e.length ? e[0].oPreviousSearch.search : void 0 : this.iterator("table", function (e) {
            e.oFeatures.bFilter && Le(e, "object" == typeof n ? B.extend(e.oPreviousSearch, n, {search: t}) : B.extend(e.oPreviousSearch, {
                search: t,
                regex: null !== n && n,
                smart: null === a || a,
        ...
        return this.iterator("column", function (e, t) {
            ...
            e.oFeatures.bFilter && ("object" == typeof r ? B.extend(n[t], r, {search: a}) : B.extend(n[t], {
                search: a,
                regex: null !== r && r,
                smart: null === o || o,
        ...
        var e = !1, n = (B.isPlainObject(t) && (e = t.api, t = t.visible), $.settings.filter(function (e) {
        ...
        return c = c || !1, this.iterator("table", function (e) {
            var t = e.oClasses, n = e.nTable, a = e.nTBody, r = e.nTHead, o = e.nTFoot, i = B(n), a = B(a),
                l = B(e.nTableWrapper), s = e.aoData.map(function (e) {
                    return e ? e.nTr : null
                }), u = t.order,
                ...
                r = e.nTableWrapper.nextSibling, u = c ? "remove" : "detach",
        ...
        var a = this.context[0], e = J(e)(a.oLanguage);
        ...
        number: function (r, o, i, l, s) {
            return null == r && (r = St), null == o && (o = Tt), {
                display: function (e) {
                    ...
                    var t = e < 0 ? "-" : "", n = parseFloat(e), a = Math.abs(n);
    ...
    var i = $.ext.type, _t = ($.type = function (a, e, t) {
        if (!e) return {
        ...
        className: "dt-type-date", detect: function (e) {
            var t;
        ...
        className: "dt-type-numeric", detect: function (e, t) {
    ...
    B.extend(!0, $.ext.renderer, {
        footer: {
            ...
            _: function (d, f, h) {
                ...
                var e = d.bSortCellsTop, t = f.closest("thead").find("tr"), n = f.parent().index();
        ...
        var t, n, u;
        return e.oFeatures.bInfo ? (t = e.oLanguage, n = e.sTableId, u = B("<div/>", {class: e.oClasses.info.container}), s = B.extend({
            ...
            var t = s, n = u, a = e._iDisplayStart + 1, r = e.fnDisplayEnd(), o = e.fnRecordsTotal(),
    ...
    function It(e, t, n, a) {
        var r = e.oLanguage.oPaginate, o = {display: "", active: !1, disabled: !1};
        switch (t) {
            case"ellipsis":
    ...
    $.feature.register("search", function (n, e) {
        ...
        function n() {
            !function e(t, n, a) {
                ...
                var r = $.ext.pager[a.type], o = t.oLanguage.oAria.paginate || {}, i = t._iDisplayStart,
                    l = t._iDisplayLength, s = t.fnRecordsDisplay(), u = -1 === l, c = u ? 0 : Math.ceil(i / l),
                    d = u ? 1 : Math.ceil(s / l), f = r().map(function (e) {
                        return "numbers" === e ? At(c, d, a.numbers) : e
                    }).flat();
                var h = [];
                for (var p = 0; p < f.length; p++) {
                    var g = f[p], m = It(t, g, c, d), v = Qe(t, "pagingButton")(t, g, m.display, m.active, m.disabled);
                    B(v.clicker).attr({
                    ...
                    }), "number" != typeof g && B(v.clicker).addClass(g), Je(v.clicker, {action: g}, function (e) {
    ...
    return $.feature.register("pageLength", function (a, e) {
        ...
        var t = a.oClasses.length, n = a.sTableId, r = e.menu, o = [], i = [];
