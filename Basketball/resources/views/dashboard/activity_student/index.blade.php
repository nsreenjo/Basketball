            ...
            <table id="res-config" class="display table table-striped table-hover dt-responsive nowrap" style="width: 100%">
                ...
                @foreach($activities as $activity)
                    <tr>
                        ...
                        <td>
                            <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Add Player">
                                <a href="{{ route('activity_students.create', ['activity_id' => $activity->id]) }}" class="avtar avtar-xs btn-link-secondary btn-pc-default">
                                    <i data-feather="plus"></i>
                                </a>
                            </li>
                            <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="View">
                                <a href="{{ route('activity_students.show', $activity->id) }}" class="avtar avtar-xs btn-link-secondary btn-pc-default">
                                    <i class="ti ti-eye f-18"></i> <!-- Eye icon for showing details -->
                                </a>
                            </li>
